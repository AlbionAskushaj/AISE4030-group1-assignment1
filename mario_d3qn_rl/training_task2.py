"""Training entry point for Task 2 D3QN with uniform experience replay."""
...
def train() -> None:
    """Run Task 2 training with replay-based D3QN updates.
    ...
    config = load_config(project_root / "config_task2.yaml")
    ...
    results_dir = project_root / "results" / "task2_d3qn_er"
    results_dir.mkdir(parents=True, exist_ok=True)

    progress_bar = tqdm(
        range(1, training_config["episodes"] + 1),
        desc="Training D3QN+ER",
        unit="episode",
    )
